...
<body class="backgrond-color-dark">
  ...
  <section>
    <nav class="navbar navbar-expand-sm ">
      ...
      <div class="navbar-nav  align-items-center">
        <span class="color-white mr-3"><i class="fa fa-angle-left fa-lg" aria-hidden="true"></i>
        </span>
        <!-- <h4 class="nav-item color-white size-large m-0 mr-4">Dashboard</h4> -->
        <a href="/dashboard"><h4 class="nav-item color-white size-large m-0 mr-4">Dashboard</h4></a>

        <h5 class="nav-item color-white m-0 mr-1 mb-1">
          <span><i class="fa fa-cube fa-lg" aria-hidden="true"></i></span>
        </h5>
        <h5 class="mr-2 nav-item color-white small m-0">Empower The Collective</h5>
          ...
          <li class="nav-item navbar-brand" data-toggle="dropdown">
            <span class="position-relative">
              ...
              <ul class="dropdown-menu text-center top-40 p-1 pl-2 pr-2 m-0 drp-border">
                ...
                <li class="divider border-bottom text-secondary p-2 font-weight-bold">Account Setting
                </li>
  ...
  <section class="mt-3 ml-5">
    <nav class="navbar navbar-expand-sm ">
      ...
      <div class="navbar-nav border rounded color-light-gray align-items-center p-1 mr-2 w-8 point pointPending" onclick="pendingShow()">
        <span class="mr-1 mt-0 nav-item color-white">
          <i class="fa fa-clock-o" aria-hidden="true"></i>
          <!-- <img src="Asset/Images/clock.png" alt="clock" class="color-white"> -->
        </span>
      ...
      <div class="navbar-nav border rounded color-light-gray align-items-center p-1 mr-2 w-10 point pointConnect" onclick="connectShow()">
        <span class="mr-1 mt-0 nav-item color-white"><i class="fa fa-check" aria-hidden="true"></i></i></span>
        <p class="mr-2 m-0 nav-item color-white size-16 display-4">Connected</p>
        <p class="m-0 nav-item color-white size-16 display-4">31</p>
      </div>
      
      <div class="navbar-nav border rounded color-light-gray align-items-center p-1 mr-2 w-8 point pointLevel">
        <span class="mr-1 mt-0 nav-item color-white">
      ...
      <div class="navbar-nav border rounded color-light-gray align-items-center p-1 mr-2 w-8 point pointInvite" onclick="inviteShow()">
        <span class="mr-1 mt-0 nav-item color-white"><i class="fa fa-envelope-o" aria-hidden="true"></i></span>
...
<div class="sec" id="invite">
  <section class="mt-3 ml-5">
    ...
    <div class="container float-left col-6 w-50">
      <form:form class="was-validated" method="POST" modelAttribute="connectModel" action="/dashboard/connect">
        <div class="form-group">
          ...
          <form:input class="form-control color-grey-lighter" id="name" path="name" placeholder="Enter Name" name="name" required="true"/>
        ...
        <div class="form-group">
          ...
          <form:input class="form-control color-grey-lighter" id="mobile" path="mobile" placeholder="Enter mobile" name="mobile" required="true"/>
          <div class="valid-feedback">Valid.</div>
          <div class="invalid-feedback">Please fill out this field.</div>
        </div>
        <div class="input-group form-group h-120">
          ...
          <textarea class="form-control color-grey-lighter" aria-label="With textarea" placeholder="Enter custom message"></textarea>
        </div>
        <div class="form-group float-right">
          <span></span>
          <button type="submit" class="btn color-grey-lighter font-weight-bold">
  ...
  <section class="mt-3 ml-5">
    <div class="container float-left ml-2 mt-5 ">
      <div class="table-title border-top border-right border-left">
        <h4 class="color-white p-4 size-large mb-0">List Of Connected Friends</h4>
      </div>
      <div>
        <table class="table table-borderless mb-0">
          <thead class="thead-color color-white border-right border-left">
            <tr>
              <th>
                Name
                <span><img src="/icons/up-and-down.png" alt="img"></span>
              </th>
              <th>
                Phone
                <span><img src="/icons/up-and-down.png" alt="img"></span>
      ...
      <div class="table-bottom border-bottom border-right border-left w-100 d-inline-block pt-3">
...
<div class="sec" id="pending">
    ...
    <section class="mt-3 ml-5">
      <div class="container float-left ml-2 mt-5 ">
        <div class="table-title border-top border-right border-left">
          <h4 class="color-white p-4 size-large mb-0">List Of Pending Referred Friends</h4>
        </div>
        <div>
          <table class="table table-borderless mb-0">
            <thead class="thead-color color-white border-right border-left">
...
function connectShow() {
  ...
  $.getJSON('/dashboard/inviteData/connected', function(data){
	  
		console.log("data : "+data);
	  $(data).each(function(i, connectModel){
	  	$('#connectedbody').append($("<tr>")
	    	.append($("<td>").append(connectModel.name))
	      	.append($("<td>").append(connectModel.mobile))
	      	.append($("<td>").append(connectModel.status))
	      	.append($("<td>").append(connectModel.dateInvite))
...
function pendingShow() {
  ...
  $.getJSON('/dashboard/inviteData/pending', function(data){
		console.log("data : "+data);
	  $(data).each(function(i, connectModel){
